...
//	 WebElement dontAllow;
	...
	public void GetStarted() throws InterruptedException {
		WAITS.waitforelementtobeclickable(driver, Started, 10).click();
		Thread.sleep(4000);
	}
...
//	}
	...
	public void LoginButton() throws InterruptedException {
		WAITS.waitforelementtobeclickable(driver, login, 10).click();
		Thread.sleep(4000);
	}
	...
	public void GoForward() throws InterruptedException {
		WAITS.waitforelementtobeclickable(driver, goForword, 10).click();
	}
	
	public void GoBackward() throws InterruptedException {
		WAITS.waitforelementtobeclickable(driver, goBackward, 10).click();
		Thread.sleep(4000);
	}
	...
	public void AboutUs() throws InterruptedException {
		WAITS.waitforelementtobeclickable(driver, aboutUs, 10).click();
	}

	public void ContactUs() throws InterruptedException {
		WAITS.waitforelementtobeclickable(driver, contactUs, 10).click();
	}

	public void FAQ() throws InterruptedException {
		WAITS.waitforelementtobeclickable(driver, faq, 10).click();
	}
	...
	public void TermsofServices() throws InterruptedException {
		WAITS.waitforelementtobeclickable(driver, terms, 10).click();
	}
	
	public void PrivacyPolicy() throws InterruptedException {
		WAITS.waitforelementtobeclickable(driver, privacypolicy, 10).click();
	}
	
	public void Xamarly() throws InterruptedException{
		WAITS.waitforelementtobeclickable(driver, xamarly, 10).click();
		Thread.sleep(5000);
	    }
